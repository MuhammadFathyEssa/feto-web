...
// Proxies a digital-twin decision simulation to the backend.
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const res = await fetch(`${BACKEND_URL}/api/twin/simulate`, {
      method: "POST",
    ...
    return NextResponse.json({ success: false, error: "Simulate request failed" }, { status: 502 });
  }
}
