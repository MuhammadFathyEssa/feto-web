          ...
          <div className="wrap">
            <div className="hero-grid">
              ...
              <div className="hero-card h-anim d3">
                ...
                <div className="hc-agent"><span className="hc-ico">✉</span><div><div className="hc-name">Correspondence</div><div className="hc-role">Executive email</div></div><span className="hc-status">drafting</span></div>
              </div>
            </div>
          </div>
        </div>
